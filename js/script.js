...
var _0xd3d6 = [
  "\x64\x34\x33\x33\x36\x35\x34\x64\x36\x64\x66\x35\x38\x62\x38\x34\x61\x36\x32\x65\x64\x33\x36\x36\x38\x34\x31\x35\x35\x64\x30\x65",
];
const API_KEY = _0xd3d6[0];
...
function displayWeather(data) {
  ...
  document.querySelector("#weather-icon0").src =
    ...
    "@2x.png";
  document.querySelector("#high0").innerText =
    Math.round(data.daily[0].temp.max) + "°";
  document.querySelector("#low0").innerText =
  ...
  document.querySelector("#weather-icon1").src =
    "http://openweathermap.org/img/wn/" +
    data.daily[1].weather[0].icon +
    "@2x.png";
  document.querySelector("#high1").innerText =
    Math.round(data.daily[1].temp.max) + "°";
  document.querySelector("#low1").innerText =
  ...
  document.querySelector("#weather-icon2").src =
    "http://openweathermap.org/img/wn/" +
    data.daily[2].weather[0].icon +
    "@2x.png";
  document.querySelector("#high2").innerText =
    Math.round(data.daily[2].temp.max) + "°";
  document.querySelector("#low2").innerText =
  ...
  document.querySelector("#weather-icon3").src =
    "http://openweathermap.org/img/wn/" +
    data.daily[3].weather[0].icon +
    "@2x.png";
  document.querySelector("#high3").innerText =
    Math.round(data.daily[3].temp.max) + "°";
  document.querySelector("#low3").innerText =
  ...
  document.querySelector("#weather-icon4").src =
    "http://openweathermap.org/img/wn/" +
    data.daily[4].weather[0].icon +
    "@2x.png";
  document.querySelector("#high4").innerText =
    Math.round(data.daily[4].temp.max) + "°";
  document.querySelector("#low4").innerText =
  ...
  document.querySelector("#weather-icon5").src =
    "http://openweathermap.org/img/wn/" +
    data.daily[5].weather[0].icon +
    "@2x.png";
  document.querySelector("#high5").innerText =
    Math.round(data.daily[5].temp.max) + "°";
  document.querySelector("#low5").innerText =
    Math.round(data.daily[4].temp.min) + "°";
}

var _0xce69 = [
  "\x66\x38\x79\x31\x69\x62\x33\x32\x76\x62\x67\x74\x78\x36\x75\x30\x6D\x65\x77\x6D\x6D\x6E\x34\x6C\x63\x75\x31\x65\x63\x76\x36\x70",
  "\x45\x49\x54\x37\x5A\x4C\x39\x56",
];
const API_TOKEN = _0xce69[0];
const API_USERID = _0xce69[1];
